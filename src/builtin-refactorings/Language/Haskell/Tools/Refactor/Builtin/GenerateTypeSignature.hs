...
generateTypeSignature' sp = undefined -- generateTypeSignature (nodesContaining sp) (nodesContaining sp) (getValBindInList sp)
...
generateTypeSignature :: Simple Traversal Module DeclList
                           ...
                           -> LocalRefactoring
generateTypeSignature topLevelRef localRef vbAccess mod = undefined
...
genTypeSig scopedSigs sigBinds vbAccess ls = undefined
  -- | Just vb <- vbAccess ls
  ...
  where isSimpleBinding vb = case vb of SimpleBind (AST.VarPat {}) _ _ -> True
                                        ...
                                        _ -> True
        dangerousTVs scopedSigs sigBinds = undefined
