...
narrowImport noNarrowSubspecs exportedModules usedNames exportedNames imp = undefined
...
neededImports exportedModules usedNames prelInsts prelFamInsts imps = undefined
...
narrowImportSpecs noNarrowSubspecs usedNames exportedNames = undefined
...
narrowImportSubspecs neededNames exportedNames ss = return ss
  -- | otherwise
