...
renameDefinition' sp str mod mods = undefined
...
renameModule isAlias from to m mods =undefined
...
renameDefinition toChangeOrig toChangeWith newName mod mods
  ...
  where
    ...
    renameInAModule toChangeOrig toChangeWith newName (name, mod) = undefined
    ...
    changeName toChangeOrig origId toChangeWith str name = undefined
